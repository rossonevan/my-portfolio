            ...
            <div className="grid grid-cols-3 gap-1 ml-6 mr-6">
                <div className="m-6">
                    <div className="flow-root">
                        <h1 className="text-center mb-3 text-xl">Cocktail Haven</h1>
                        <a href="https://github.com/rossonevan/cocktailhaven" className="float-left">Github</a>
                        <a href="https://www.loom.com/share/0fd20c7321834f8c88bdc06049bbc2a8" className="float-right">Demo</a>
                    </div>
                    ...
                    <br></br>
                    <button onClick={() => setProject1Details(!project1Details)}>More InDepth Details</button>
                ...
                <div className="m-6">
                    <div>
                        <h1 className="text-center mb-3 text-xl">Guitar Heroes</h1>
                        <a href="https://github.com/xauvk/guitar-heroes" className="float-left">Github</a>
                        <a href="https://www.loom.com/share/a81b774e25334ce693f07ec5687dd18f" className="float-right">Demo</a>
                    </div>
                    ...
                    <button onClick={() => setProject2Details(!project2Details)}>More InDepth Details</button>
                ...
                <div className="m-6">
                    <div className="flow-root">
                        <h1 className="text-center mb-3 text-xl">Worth-to-Play</h1>
                        <a href="https://github.com/rossonevan/worth-to-play" className="float-left">Github</a>
                        <a href="https://www.loom.com/share/e6db69f9b0564e01814c61e129386b67" className="float-right">Demo</a>
                    ...
                    <p className="text-center">Project Description: </p>
                    <p className="text-center">An application that provides the user with six random cocktails with instructions on how to make them and also allows the user to upload their own cocktails with instructions.</p>
                    <button onClick={() => setProject3Details(!project3Details)}>More InDepth Details</button>
